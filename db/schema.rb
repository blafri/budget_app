...
ActiveRecord::Schema.define(version: 20150725165235) do
  ...
  add_index "acct_transactions", ["bank_account_id"], name: "index_acct_transactions_on_bank_account_id", using: :btree
  ...
  add_foreign_key "acct_transactions", "bank_accounts"
